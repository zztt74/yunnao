package com.neusoft.cloudbrain.patient.exception;

import com.neusoft.cloudbrain.common.exception.BusinessException;

/**
 * 患者模块错误码及对应的 HTTP 状态码
 *
...
public enum PatientErrorCode {
    ...
    PATIENT_PROFILE_NOT_FOUND("患者档案不存在", 404),
    PATIENT_PERMISSION_DENIED("无权访问他人患者信息", 403),
    ...
    PatientErrorCode(String message, int httpStatus) {
